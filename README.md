...
```js
{
  ...
  /* bgSize: CSS background-size property */
   ...
   history: { // If this is present in a tile, a history popup is created on long-press
      ...
      chart: { data: { datasets: [{ borderColor: 'red' }] } }, // Chart options. Refer to https://www.chartjs.org/.
